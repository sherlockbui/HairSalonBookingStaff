...
public class AdminCustomStateDialog {
    public static AdminCustomStateDialog mDialog;
    ...
    public static AdminCustomStateDialog getInstance() {
        if (mDialog == null) {
            mDialog = new AdminCustomStateDialog();
        }
        return mDialog;
    }
